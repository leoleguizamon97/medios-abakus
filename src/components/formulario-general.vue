	...
	<form>
		<div class="card m-3">
			...
			<div class="card-body">
				...
				<input class="form-control" type="file" id="terceros-path" ref="terceros" placeholder="terceros.txt" required>
				...
				<div class="d-flex my-2">
					...
					<button type="submit" class="btn btn-warning w-25 mx-2" title="descargar" @click="generarArchivo">
